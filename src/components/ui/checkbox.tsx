  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        // Background colors - using explicit white/dark colors instead of CSS custom properties
        "bg-white border-gray-300",
        "dark:bg-gray-800 dark:border-gray-600",
        // Checked state
        "data-[state=checked]:bg-blue-600 data-[state=checked]:text-white data-[state=checked]:border-blue-600",
        "dark:data-[state=checked]:bg-blue-500 dark:data-[state=checked]:text-white dark:data-[state=checked]:border-blue-500",
        // Focus state
